...
.L14:
	...
	lw	a4,-28(s0)
	add	a5,a4,a5
	.loc 3 135 40 discriminator 3
	lw	a5,0(a5)
	.loc 3 135 51 discriminator 3
	slli	a4,a5,16
	.loc 3 135 5 discriminator 3
	li	a5,637534208
	addi	a5,a5,12
	.loc 3 135 38 discriminator 3
	sw	a4,0(a5)
	.loc 3 134 24 discriminator 3
	lw	a5,-24(s0)
	addi	a5,a5,1
	sw	a5,-24(s0)
.L13:
	.loc 3 134 18 discriminator 1
	lw	a4,-24(s0)
	li	a5,63
	ble	a4,a5,.L14
.LBE4:
.LBE3:
	.loc 3 131 26 discriminator 2
	lw	a5,-20(s0)
	addi	a5,a5,1
	sw	a5,-20(s0)
.L12:
	.loc 3 131 20 discriminator 1
	lw	a4,-20(s0)
	li	a5,2
	ble	a4,a5,.L15
.LBE2:
