# 0 "func.c"
# 1 "/home/ubuntu/SoCLab/final_project/testbench/top//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "func.c"
# 1 "../../firmware/defs.h" 1
...
{
 (*(volatile uint32_t*) 0x32000010) = 0;
 (*(volatile uint32_t*) 0x32000014) = 1;
 (*(volatile uint32_t*) 0x32000018) = 2;
 (*(volatile uint32_t*) 0x3200001c) = 3;
 (*(volatile uint32_t*) 0x32000020) = 0;
 (*(volatile uint32_t*) 0x32000024) = 1;
 (*(volatile uint32_t*) 0x32000028) = 2;
 (*(volatile uint32_t*) 0x3200002c) = 3;
 (*(volatile uint32_t*) 0x32000030) = 0;
 (*(volatile uint32_t*) 0x32000034) = 1;
 (*(volatile uint32_t*) 0x32000038) = 2;
 (*(volatile uint32_t*) 0x3200003c) = 3;
 (*(volatile uint32_t*) 0x32000040) = 0;
 (*(volatile uint32_t*) 0x32000044) = 1;
 (*(volatile uint32_t*) 0x32000048) = 2;
 (*(volatile uint32_t*) 0x3200004c) = 3;

 (*(volatile uint32_t*) 0x32000050) = 1 ;
 (*(volatile uint32_t*) 0x32000054) = 2 ;
 (*(volatile uint32_t*) 0x32000058) = 3 ;
 (*(volatile uint32_t*) 0x3200005c) = 4 ;
 (*(volatile uint32_t*) 0x32000060) = 5 ;
 (*(volatile uint32_t*) 0x32000064) = 6 ;
 (*(volatile uint32_t*) 0x32000068) = 7 ;
 (*(volatile uint32_t*) 0x3200006c) = 8 ;
 (*(volatile uint32_t*) 0x32000070) = 9 ;
 (*(volatile uint32_t*) 0x32000074) = 10;
 (*(volatile uint32_t*) 0x32000078) = 11;
 (*(volatile uint32_t*) 0x3200007c) = 12;
 (*(volatile uint32_t*) 0x32000080) = 13;
 (*(volatile uint32_t*) 0x32000084) = 14;
 (*(volatile uint32_t*) 0x32000088) = 15;
 (*(volatile uint32_t*) 0x3200008c) = 16;

 for (int i=0; i<16; i++) {
  result_mm[i] = (*(volatile uint32_t*) 0x32000090);
 }
 return result_mm;
}
...
int* __attribute__ ( ( section ( ".mprjram" ) ) ) fir(){
 ...
 (*(volatile uint32_t*) 0x31000010) = 0;
 (*(volatile uint32_t*) 0x31000014) = -10;
 (*(volatile uint32_t*) 0x31000018) = -9;
 (*(volatile uint32_t*) 0x3100001c) = 23;
 (*(volatile uint32_t*) 0x31000020) = 56;
 (*(volatile uint32_t*) 0x31000024) = 63;
 (*(volatile uint32_t*) 0x31000028) = 56;
 (*(volatile uint32_t*) 0x3100002c) = 23;
 (*(volatile uint32_t*) 0x31000030) = -9;
 (*(volatile uint32_t*) 0x31000034) = -10;
 (*(volatile uint32_t*) 0x31000038) = 0;
 (*(volatile uint32_t*) 0x31000044) = 11;

 (*(volatile uint32_t*) 0x3100003c) = 1;
 outputsignal[0] = (*(volatile uint32_t*) 0x31000040);
 (*(volatile uint32_t*) 0x3100003c) = 2;
 outputsignal[1] = (*(volatile uint32_t*) 0x31000040);
 (*(volatile uint32_t*) 0x3100003c) = 3;
 outputsignal[2] = (*(volatile uint32_t*) 0x31000040);
 (*(volatile uint32_t*) 0x3100003c) = 4;
 outputsignal[3] = (*(volatile uint32_t*) 0x31000040);

 (*(volatile uint32_t*) 0x3100003c) = 5;
 outputsignal[4] = (*(volatile uint32_t*) 0x31000040);
 (*(volatile uint32_t*) 0x3100003c) = 6;
 outputsignal[5] = (*(volatile uint32_t*) 0x31000040);
 (*(volatile uint32_t*) 0x3100003c) = 7;
 outputsignal[6] = (*(volatile uint32_t*) 0x31000040);
 (*(volatile uint32_t*) 0x3100003c) = 8;
 outputsignal[7] = (*(volatile uint32_t*) 0x31000040);
 (*(volatile uint32_t*) 0x3100003c) = 9;
 outputsignal[8] = (*(volatile uint32_t*) 0x31000040);
 (*(volatile uint32_t*) 0x3100003c) = 10;
 outputsignal[9] = (*(volatile uint32_t*) 0x31000040);
 (*(volatile uint32_t*) 0x3100003c) = 11;
 outputsignal[10] = (*(volatile uint32_t*) 0x31000040);
 return outputsignal;
}
...
int* __attribute__ ( ( section ( ".mprjram" ) ) ) qsort(){
 (*(volatile uint32_t*) 0x33000010) = 893;
 (*(volatile uint32_t*) 0x33000014) = 40;
 (*(volatile uint32_t*) 0x33000018) = 3233;
 (*(volatile uint32_t*) 0x3300001c) = 4267;
 (*(volatile uint32_t*) 0x33000020) = 2669;
 (*(volatile uint32_t*) 0x33000024) = 2541;
 (*(volatile uint32_t*) 0x33000028) = 9073;
 (*(volatile uint32_t*) 0x3300002c) = 6023;
 (*(volatile uint32_t*) 0x33000030) = 5681;
 (*(volatile uint32_t*) 0x33000034) = 4622;

 for (int i=0; i<10; i++) {
  QS_results[i] = (*(volatile uint32_t*) 0x33000038);
 }
 return QS_results;
}
