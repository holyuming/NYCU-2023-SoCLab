...
// ==============================================================
`timescale 1ns/1ps
module fir_n11_strm_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_IER                = 7'h08,
    ADDR_ISR                = 7'h0c,
    ADDR_REGXFERLENG_DATA_0 = 7'h10,
    ADDR_REGXFERLENG_CTRL   = 7'h14,
...
//------------------------Instantiation------------------
// int_an32Coef
fir_n11_strm_control_s_axi_ram #(
    .MEM_STYLE ( "auto" ),
    .MEM_TYPE  ( "2P" ),
    .BYTES     ( 4 ),
    .DEPTH     ( 12 )
...
module fir_n11_strm_control_s_axi_ram
#(parameter
    MEM_STYLE = "auto",
    MEM_TYPE  = "S2P",
    BYTES  = 4,
