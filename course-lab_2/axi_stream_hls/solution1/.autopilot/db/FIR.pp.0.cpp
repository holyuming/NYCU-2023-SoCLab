...
__attribute__((sdx_kernel("fir_n11_strm", 0))) void fir_n11_strm(stream_t* pstrmInput, stream_t* pstrmOutput, int32_t an32Coef[(((11 + 3) >> 2) << 2)], reg32_t regXferLeng)
{
#line 17 "/home/ubuntu/course-lab_2/axi_stream_hls/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=fir_n11_strm
# 5 "hls_FIRN11Stream/FIR.cpp"

#line 6 "/home/ubuntu/course-lab_2/axi_stream_hls/solution1/directives.tcl"
#pragma HLSDIRECTIVE TOP name=fir_n11_strm
# 5 "hls_FIRN11Stream/FIR.cpp"

#pragma HLS INTERFACE s_axilite port=regXferLeng
#pragma HLS INTERFACE s_axilite port=an32Coef
#pragma HLS INTERFACE mode=axis register_mode=both port=pstrmOutput register
#pragma HLS INTERFACE mode=axis register_mode=both port=pstrmInput register
