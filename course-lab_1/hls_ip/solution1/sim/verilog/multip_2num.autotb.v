...
reg dump_tvout_finish_pn32ResOut;

initial begin : dump_tvout_runtime_sign_pn32ResOut
    integer fp;
    dump_tvout_finish_pn32ResOut = 0;
    ...
    fp = $fopen(`AUTOTB_TVOUT_pn32ResOut_out_wrapc, "a");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_pn32ResOut_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
    ...
    $fdisplay(fp,"[[[/runtime]]]");
    $fclose(fp);
    dump_tvout_finish_pn32ResOut = 1;
end
